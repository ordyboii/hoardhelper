...
describe("Renamer Logic", () => {
  describe("Parser Logic", () => {
    const testCases = [
      ...
      {
        input:
          "The.Mandalorian.S02E05.Chapter.13.The.Jedi.1080p.DSNP.WEBRip.DDP5.1.Atmos.x264-SCREENER.mkv",
      ...
      {
        input:
          "Avatar.2009.EXTENDED.REPACK.1080p.BluRay.x264.AAC5.1-[YTS.MX].mp4",
        expectedSeries: "Avatar 2009",
        type: "movie",
      },
      {
        input:
          "The.Mandalorian.S02E05.Chapter.13.The.Jedi.1080p.DSNP.WEBRip.DDP5.1.Atmos.x264.mkv",
        expectedSeries: "The Mandalorian",
        expectedS: 2,
        expectedE: 5,
        type: "tv",
